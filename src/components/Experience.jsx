  ...
  return (
    ...
    >
      <motion.div
        ...
        className="hover:bg-purple-600 hover:text-white p-4 rounded-xl shadow-md w-[370px] max-[465px]:w-full max-[465px]:px-4"
      >
        <h1 className="font-[poppins] font-bold text-[15px]">
          {item.company}: {item.location}
        </h1>
        <h2 className="font-[poppins] font-semibold text-[13px]">
          {item.jobTitle}
        </h2>
        <h3 className="font-[poppins] font-semibold text-[12px]">
          {item.date}
        </h3>
        <ul className="text-[12px] font-[poppins] list-disc pl-4">
...
const Experience = () => {
  return (
    ...
    >
      <h1 className="text-3xl text-purple-600 font-bold font-[poppins] mb-10">
        Experience
      </h1>
